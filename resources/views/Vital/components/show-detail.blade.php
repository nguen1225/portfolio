<div class="bg-white px-4 py-5 sm:px-2 border-b border-gray-200 rounded-lg">
    <h4 class="underline text-xl font-semibold">
        備考
    </h4>
