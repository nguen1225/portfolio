...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="min-h-full flex items-center justify-center bg-gray-700 p-6 rounded-lg shadow-2xl">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('password.generate-url')); ?>" method="POST">
...
<?php echo $__env->make('layouts.detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /work/resources/views/password/send-email.blade.php ENDPATH**/ ?>